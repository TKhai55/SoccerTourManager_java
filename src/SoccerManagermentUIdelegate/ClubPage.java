...
public class ClubPage extends javax.swing.JFrame {
    ...
    public ClubPage(int clbid,int tourid) {
        idCLB=clbid;
        idtour=tourid;
        initComponents();
    ...
    private void initComponents() {
        ...
        pannelOverviewLayout.setHorizontalGroup(
            ...
            .addGroup(pannelOverviewLayout.createSequentialGroup()
                .addGroup(pannelOverviewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pannelOverviewLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblName, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
        ...
        javax.swing.GroupLayout panelMatchLayout = new javax.swing.GroupLayout(panelMatch);
        panelMatch.setLayout(panelMatchLayout);
        panelMatchLayout.setHorizontalGroup(
            panelMatchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane2)
            .addGroup(panelMatchLayout.createSequentialGroup()
                .addGap(266, 266, 266)
                .addComponent(DateMatch, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelMatchLayout.setVerticalGroup(
            ...
            .addGroup(panelMatchLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelMatchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jTabbedPane1.addTab("Match Shedules", panelMatch);
        ...
        btnSearchResult.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnSearchResultMouseClicked(evt);
            }
        });

        btnRefresh1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagestore/refresh.png"))); // NOI18N
        ...
        panelResultLayout.setHorizontalGroup(
            ...
            .addGroup(panelResultLayout.createSequentialGroup()
                .addGap(319, 319, 319)
                .addComponent(DateResult, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnSearchResult, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.addTab("Match Result", panelResult);
    ...
    private void btnSearchResultMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSearchResultMouseClicked
        // TODO add your handling code here:
        perday=true;
        ...
        LoadResultPerDate();
    }//GEN-LAST:event_btnSearchResultMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClubPage(idCLB,idtour).setVisible(true);
            }
        });
    }
    ...
    private void LoadClubOverview(int clbid) {
        ...
        public void Loadclb(int tourid){
    ...
    public void LoadListMatch(int clbid){
        Loadclb(idtour);
        ListMatch.ListMatch.removeAll(ListMatch.ListMatch);
        Connection con=new ConnectDB().createConn();
        String sqlClub="select * from match1 where clb1=? or clb2=?";
        try{
            PreparedStatement pre= con.prepareStatement(sqlClub,ResultSet.TYPE_SCROLL_SENSITIVE, 
                        ResultSet.CONCUR_UPDATABLE);
            pre.setInt(1, clbid);
