...
public final class StartingPage extends javax.swing.JFrame {
    ...
    public StartingPage(String user) {
        ...
        operation.listTournamentsinStartingPage(listTour, this,user);
        listid=operation.getTourid(user);
    ...
    private void initComponents() {
        ...
        btnLogOut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagestore/log-out.png"))); // NOI18N
   ...
   int tourid=0;
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        this.dispose();
        new CreateTour(useraccount).setVisible(true);
